...
- [x] SaaS stat cards 2026-09-25 (`feat/stat-cards-saas`): all 16 KPI cards site-wide restyled to small label on top + big number below with no icons (pastel tones + grids unchanged, still filter-driven); dead icon props, imports, and CSS removed
