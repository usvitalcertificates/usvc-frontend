    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "• The disclosed all-inclusive order total contains USVC's value-added assistance fee and a bundled amount for government, agency, and shipping costs (see Section 6).",
      ...
      },
      {
        ...
        body: [
          ...
          "• USVC service fee: for our application preparation, review, submission assistance, support, and operational costs.",
          "• Government agency fees: mandatory fees for the vital record, collected by us and remitted to the agency.",
          "• Government / Agency Fee & Shipping bundle: a fixed per-copy amount based on domestic or international delivery that covers expected government, agency, fulfillment, shipping, and payment-processing costs.",
          "All fees are in U.S. Dollars. The complete total is disclosed before payment and collected in one transaction. USVC service fees and bundle prices for new orders are subject to change, but a completed payment will not create a separate later customer charge for that order. You warrant your payment information is accurate and authorized. You are responsible for applicable taxes.",
